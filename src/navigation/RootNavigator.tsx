...
import AdminBetaRiskSummaryScreen from '../screens/admin/AdminBetaRiskSummaryScreen';
    ...
    >
      {pending2FA ? (
        ...
        <>
          ...
          <Stack.Screen name="AdminBetaRiskSummary" component={AdminBetaRiskSummaryScreen} options={{ headerShown: false }} />
